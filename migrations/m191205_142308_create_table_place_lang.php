...
/**
 * Class m191205_142308_create_table_place_lang
 */
class m191205_142308_create_table_place_lang extends Migration
{
    ...
    public function up()
    {
        ...
        $this->addForeignKey('fk_place_lang_place_id_place','place_lang', 'place_id', 'id');
    }
    ...
    {
        echo "m191205_142308_create_table_place_lang cannot be reverted.\n";
